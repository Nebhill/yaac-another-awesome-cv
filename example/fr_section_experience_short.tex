    ...
    {Avril 2017}    {Consultant}{Novartis, Bank for International Settlements, Johnson \& Johnson, Nations Unies, Ville de Genève, Die Mobiliar, Audemars Piguet, La Mutuelle ...} {
        ...
        \vspace{0.3em}  % ← ajoute un petit espace entre le titre et le début de la liste
          \item \textbf{Architecture \& intégration IT} :
            \begin{itemize}[itemsep=0.2em,topsep=0.2em,parsep=0pt]
              ...
              \item Intégration avec Active Directory, SSO (\emph{SAML2, OpenID}) et autres systèmes IT.
        ...
        \vspace{0.3em}  % ← ajoute un petit espace entre le titre et le début de la liste
          \item \textbf{Automatisation \& DevOps} :
            \begin{itemize}[itemsep=0.2em,topsep=0.2em,parsep=0pt]
              \small
              \item Automatisation des déploiements ECM via \textbf{Ansible}, Kubernetes et CI/CD.
              \item \textbf{Déploiement de pipelines CI/CD} et monitoring centralisé (Prometheus, Grafana, ELK).
            \end{itemize}                                    
        \vspace{0.3em}  % ← ajoute un petit espace entre le titre et le début de la liste
