...
\usepackage{csquotes}
\name{Nabil}{Laabd}
\tagline{IT Consultant | DevOps Engineer }
\photo{2.5cm}{nla}
\socialinfo{
...
\begin{document}
	...
	\makecvfooter
		...
		{\textsc{nabil laabid - IT Consultant | DevOps Engineer}} %\selectlanguage{english}Nabil Laabid - IT Consultant | DevOps Engineer
		{\thepage}
